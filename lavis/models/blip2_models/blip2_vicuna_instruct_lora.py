...
class Blip2VicunaInstructLoRA(Blip2Base):
    ...
    def __init__(
        ...
        if lora_on_Qformer:
            peft_config = LoraConfig(
                ...
                target_modules='.*(attention).*(query|value)',
        ...
        # self.llm_tokenizer.add_special_tokens({'unk_tokekn': '</s>'})
    ...
    def from_config(cls, cfg):
        ...
        finetuned = cfg.get("finetuned", True)
        
        lora_on_Qformer = cfg.get("lora_on_Qformer", True)
        lora_on_LLM = cfg.get("lora_on_LLM", True)
        ...
        model = cls(
            ...
            finetuned=finetuned,
            lora_on_Qformer=lora_on_Qformer,
            lora_on_LLM=lora_on_LLM,
